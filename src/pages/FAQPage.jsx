const dataFAQs = [["Chatbot hoạt động như thế nào?","Chatbot hoạt động bằng cách từ câu hỏi của người dùng, sử dụng kỹ thuật tìm văn bản liên quan đến câu hỏi trong bộ dữ liệu đã được vector hóa (text similarity) và lưu trữ vào database. Giúp lấy ra những đoạn văn bản có liên quan sau đó dùng mô hình reranker để lấy ra câu hỏi liên quan nhất và câu trả lời tương ứng."],
...
["Tôi có thể liên hệ hỗ trợ như thế nào?","Vào phần Góp ý/Báo lỗi hoặc thông qua các cổng thông tin của Học Viện."],
]
function FAQPage() {
  return (
    <div className="flex justify-center min-h-[85vh] h-auto bg-gradient-to-br from-blue-100 to-purple-100">
      <div className="md:w-[50%]">
        ...
        {
          dataFAQs.map((item,i)=><div key={i} className="mt-2 collapse collapse-plus shadow-md rounded-xl bg-white hover:scale-105">
          <input type="checkbox" />
